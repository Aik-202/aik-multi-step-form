...
export default function NavBar(props) {
  return (
   ...
   ${props.plans ? 'lg:w-[30%] lg:pb-44' : 'sm:w-[50%]'}
   ${props.addons ? 'sm:w-[50%] lg:w-[31%] sm:pb-40 lg:pb-44' : 'sm:w-[50%] lg:pb-36'}
   ${props.finished ? 'sm:w-[40%] lg:w-[32%] xl:w-[30%] sm:pb-32 lg:pb-44' : 'sm:w-[50%]'}`}> 
